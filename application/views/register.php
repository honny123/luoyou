...
<html lang="en">
	<head>
		<meta charset="utf-8"/>
		<title>裸游网_会员注册</title>
		<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/normalize.css'); ?>"/>
		<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/register.css'); ?>"/>
	</head>
	<body>
		<div class="header_bg">
			<div class="header">
				<div class="ly-logo">
					<a href="#"><img src="<?php echo site_url('assets/images/logo_v4.gif'); ?>" target="_blank"/></a>
				</div>
				<p class="head_tip">
					欢迎注册
				</p>
		...
		<div class="container">
			...
			<div class="reg_user">
				<div class="reg_field">
					<div class="reg_field_head">
						<span>邮箱注册</span>
					</div>
					<div class="reg_field_user">
						<div class="main_item">
							<div class="step step1"></div>
							<ul class="ipt_list">
								<li class="reg_user_email">
									<div class="reg_ipt">
								...
								<li class="reg_check">
									<div>
										<br>
										<input type="checkbox" name="travel_info" id="travel_info" checked="checked">
										<label for="travel_info">愿意接受旅游资讯免费信息</label>
										<a href="javascript:void(0)" class="agreement">裸游会员协议</a>
									</div>
								</li>
							</ul>
							<div class="reg_submit">
								<input type="submit" class="register_btn step1_next" value="下一步"/>
							</div>
						</div>
					</div>
				</div>
    ...
    <div id="dyPop" class="dyPop">
      <div class="popping-box-border"></div>
      <div class="dyPop_con">
        <div class="dy_tit">
          <p>裸游会员协议</p>
          <a id="dyClose" class="dyClose">x</a>
        </div>
        <div class="logintextarea">
          <h3 class="sc_title">&lt;&lt;裸游会员协议&gt;&gt;</h3>
          <p class="sc_list">一、服务条款</p>
          <p class="sc_con">
            裸游网提供的服务将完全按照其发布的使用协议、服务条款和操作规则严格执行。为获得裸游服务，服务使用人（以下称"会员"）应当同意本协议的全部条款并按照页面上的提示完成全部的注册程序。
          </p>
          <p class="sc_list">二、目的</p>
          <p class="sc_con">本协议是以规定用户使用裸游网提供的服务时，裸游网与会员间的权利、义务、服务条款等基本事宜为目的。</p>
          ...
          <p class="sc_con">裸游服务的具体内容由本网站根据实际情况提供，本网站保留随时变更、中断或终止部分或全部裸游服务的权利。</p>
          <p class="sc_list">五、会员的义务</p>
          <p class="sc_con">
            用户在申请使用本网站途牛服务时，必须向本网站提供准确的个人资料，如个人资料有任何变动，必须及时更新。
            <br>
            <br>
            ...
            <br>
            不得利用裸游服务系统传输任何危害社会，侵蚀道德风尚，宣传不法宗教组织等内容；
            <br>
            不得利用裸游服务系统进行任何可能对互联网的正常运转造成不利影响的行为；
            <br>
            不得利用裸游服务系统上载、张贴或传送任何非法、有害、胁迫、滥用、骚扰、侵害、中伤、粗俗、猥亵、诽谤、侵害他人隐私、辱骂性的、恐吓性的、庸俗淫秽的及有害或种族歧视的或道德上令人不快的包括其他任何非法的信息资料；
            <br>
            不得利用裸游服务系统进行任何不利于本网站的行为；
            <br>
          ...
          <p class="sc_con">
            ...
            有损于本网站，会员或第三者名誉的内容；
            <br>
            利用裸游服务系统上载、张贴或传送任何非法、有害、胁迫、滥用、骚扰、侵害、中伤、粗俗、猥亵、诽谤、侵害他人隐私、辱骂性的、恐吓性的、庸俗淫秽的及有害或种族歧视的或道德上令人不快的包括其他任何非法的内容；
            <br>
            侵害本网站或第三者的版权，著作权等内容；
            <br>
            存在与本网站提供的服务无关的内容；
          ...
          <p class="sc_con">
            本网站（www.luryer.com）所有的产品、技术与所有程序及页面（包括但不限于页面设计及内容）均属于知识产权，仅供个人学习、研究和欣赏，未经授权，任何人不得擅自使用，否则，将依法追究法律责任。
            <br>
            <br>
            杭州裸游科技有限公司拥有本网站内所有资料（包括但不限于本站所刊载的图片、视频、Flash等）的版权，（版权归属有特殊约定的，从其约定），未经授权，任何人不得擅自使用，否则，将依法追究法律责任。
            <br>
            <br>
            "裸游网"、牛头（图形）及"luryer.com"组合为南京途牛科技有限公司注册商标，任何人不得擅自使用，否则，将依法追究法律责任。
          </p>
          ...
          <p class="sc_con">
            如因系统维护或升级的需要而需暂停途牛服务，本网站将尽可能事先进行通告。
            <br>
            <br>
            如发生下列任何一种情形，本网站有权随时中断或终止向用户提供本协议项下的途牛服务而无需通知用户：
            <br>
            <br>
            用户提供的个人资料不真实；
            <br>
            ...
            <br>
            <br>
            除前款所述情形外，本网站同时保留在不事先通知用户的情况下随时中断或终止部分或全部途牛服务的权利，对于所有服务的中断或终止而造成的任何损失，本网站无需对用户或任何第三方承担任何责任。
          </p>
          ...
          <p class="sc_con">
            ...
            <br>
            <br>如果不同意本网站对服务条款所做的修改，用户有权停止使用途牛服务。如果用户继续使用途牛服务，则视为用户接受服务条款的变动。</p>
          ...
          <p class="sc_con">
            ...
            <br>
            <br>如本协议中的任何条款无论因何种原因完全或部分无效或不具有执行力，本协议的其余条款仍应有效并且有约束力。</p>
